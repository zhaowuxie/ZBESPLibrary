define(["vue","MINT", "txt!../../pages/groupColor.html", "../js/colorPicker", "../js/groupInfo", "../js/otaInfo" ],
    function(v, MINT, groupColor, colorPicker, groupInfo, otaInfo) {
    ...
    var GroupColor = v.extend({
        ...
        methods:{
            show: function() {
                ...
                self.showFlag = true;
                setTimeout(function() {
                    $("#"+ self.lightId + " span.span-radio").addClass("active");
                }, 200);
            },
            hide: function () {
            ...
            editName: function () {
                ...
                MINT.MessageBox.prompt(self.$t('editNameInput'), self.$t('addGroupTitle'),
                    ...
                    window.espmesh.saveGroup(self.group.id, obj.value, null);
            ...
            dissolutionGroup: function (e) {
                ...
                MINT.MessageBox.confirm(self.$t('delGroupDesc'), self.$t('delGroupTitle'),{
                    ...
                    self.hideOperate();
                    window.espmesh.deleteGroup(self.group.id);
                    self.changeStore();
                    self.$store.commit("setGroupList", self.groupList);
            ...
            initAttrSlider: function(id, value, perms) {
                var self = this;
                setTimeout(function() {
