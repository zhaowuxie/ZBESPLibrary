define(["vue", "MINT", "txt!../../pages/recent.html", "../js/footer", "./resetDevice", "../js/addGroup",
    "../js/groupInfo", "./operateDevice", "../js/groupColor", "./aboutDevice", "./otaInfo", "./automation", "./attr"],
    function(v, MINT, recent, footer, resetDevice, addGroup, groupInfo, operateDevice,
