define(["vue", "MINT", "IScroll", "txt!../../pages/table.html", "../js/info", "../js/setTable", "../js/tableColor"],
    function(v, MINT, IScroll, table, info, setTable, tableColor) {
    ...
    var Table = v.extend({
        ...
        methods:{
            show: function() {
                var self = this;
                window.onBackPressed = self.hideTable;
            ...
            lightDrop: function () {
                ...
                $('#collapse-light-table').on({
                    ...
                    touchend: function() {
                        ...
                        if (!self._isEmpty(TIMER_DROP) && POSITION_TOP == top && POSITION_LEFT == left) {
